...
<!-- NAVBARS -->
			...
			<div class="sidebar">
                <a href="paymasterINDEX.php" class="active" style="color: white;"><i class="fa fa-tachometer"></i> Dashboard</a>
				<hr>
				<a href="paymasterEMPLOYEE.php" ><i class="fa fa-users"></i> Employees</a>
				<a href="paymasterPAYROLL.php" class="active" style="color: white;"s ><i class='fa fa-line-chart'></i> Payroll</a>
				<a href="paymasterUSERS.php"><i class='fa fa-gear'></i> Account Settings</a>
			</div>
<!-- NAVBARS -->			
                    ...
                    <div class="modal-body">
                        <form action="process.php" method="POST" >
                            <div class="col" style="margin-left: 20px;">
                                    <div class="row" >
                                            <h5>Coverage Dates for the payroll </h5>
                                            <div class="col">
                                                    <h6> Starting Date <h6>
                    ...
                    <div class="modal-body">
                        <form action="process.php" method="POST" >
                            <div class="col" style="margin-left: 20px;">
                                    ...
                                    <p style="font-size: 30px;display:none;"> <span id="currDate" name="dateID"></span></p>
                                        <p><b>ID Number:</b>  <span id="empIDs" name="empIDn"></span></p>
