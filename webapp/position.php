...
<!-- NAVBARS -->
			...
			<div class="sidebar">
				...
				<a href="position.php"class="active" style="color:white"><i class="fa fa-briefcase"></i> Positions</a>
				<a href="payroll.php"><i class='fas fa-chart-line'></i> Payroll</a>
...
<!-- NAVBARS -->			
	<div class="containers">
                ...
                <?php
                    ...
                    $result = $mysqli -> query("SELECT * FROM position");
                ?>      
        <div class="box2" style="box-shadow: 0px 3px 4px 1px #d6d6d6;">
            ...
            <div class="row" style="margin-left: 10px; width:1155px; font-size:12px;">
                <table class="table">
                    ...
                    ?> 
                        <tr>
                            <td style="display:none;"><?php echo $row['positionID']; ?></td>
                            <td class="userClass"><?php echo $row['positionName']; ?></td>
                            <td class="passClass"><?php echo $row['positionFee']; ?></td>
                            <td>
...
<div class="modal fade" id="deleteModalPos" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content" style="height: 390px;">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel" style="margin-left:50px;"><i class="fa fa-trash" aria-hidden="true" style="color:red"></i>  You are about to delete a position</h5>
                ...
                <form action="process.php" method="POST">
                    ...
                    <div class="modal-body" style="text-align: justify;">
                        <div class="danger-box">
                            ...
                            <p style="margin-left: 50px;color:#d36d55;margin-bottom:10px;padding-right: 25px;">This position will be permanently delete and you won't be able to see this again</p>
                        </div>
                        <div class="text-center" style="margin-top: 10px;">
                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal" style="padding: 10px 30px 10px 30px">Cancel</button>
                            <button type="submit" name="deletePos" class="btn btn-danger" id="delete" style="padding: 10px 30px 10px 30px">Confirm</button>
                        </div>
                    </div>
                </form>
            ...
            <div class="modal-content" style="height: 350px;">
                ...
                <form action="process.php" method="POST">
                    <div class="modal-body">
                        ...
                        <input type="hidden" id="id1" name="id" value="<?php echo $positionID ?>">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" name="updatePos" class="btn btn-primary" id="updates">Update Data</button>
                        </div>
                </form>
            </div>
        </div>
